...
export const metadata = {
  ...
  description:
    "Sedo Logistics develops comprehensive freight forwarding, project logistics and relocation service plans tailored to meet specific requirements of customer",
};
    ...
    <>
      <html lang="en">
        <head>
          ...
          <meta
            property="og:title"
            content="Sedo Logistics Limited - Leading logistics company providing best logistics Solution"
          />
